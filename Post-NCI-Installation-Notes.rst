...
2.  Visit ``PORTAL_URL/RAMCache/manage_workspace``.  It'll be slow.
...
1.  Visit https://edrn.nci.nih.gov/portal_skins/custom/manage_main in a
    browser; click the name of the SCRIPT in the list.  This is the *source*.
